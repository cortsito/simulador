export default function Layout({ children, onNavigateHome, onNavigateTerms, onNavigateRepaso, onNavigateSuggestions, ankiDeckCount }) {
  return (
        ...
        <div className="max-w-5xl mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex flex-wrap justify-center items-center gap-x-8 gap-y-4 text-sm font-medium">
              ...
              <a href="https://www.facebook.com/corttt0/" target="_blank" rel="noreferrer" className="flex items-center gap-2 text-gray-400 hover:text-blue-400 transition-colors">
              ...
              <a href="https://x.com/cortsito" target="_blank" rel="noreferrer" className="flex items-center gap-2 text-gray-400 hover:text-white transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
